...
export const exampleCashFlowIngestionProfiles: ClientIngestionProfile[] = [
  ...
  {
    id: 'el-carmen-cashflow-brasil-wide-months',
    businessId: 'el-carmen',
    datasetType: 'cash-flow',
    sourceName: 'Fluxo de caixa Entradas e Saidas 2026 2027',
    acceptedFormats: ['xlsx'],
    requiresHumanApproval: true,
    lastReviewedAt: '2026-05-23',
    mappings: [
      { clientColumn: 'Mapa cuentas!Tipo', standardField: 'category', confidence: 0.95, approved: true, notes: 'Define entrada o salida.' },
      { clientColumn: 'Mapa cuentas!Grupo', standardField: 'subcategory', confidence: 0.93, approved: true, notes: 'Agrupador de gestion.' },
      { clientColumn: 'Mapa cuentas!Cuenta', standardField: 'concept', confidence: 0.97, approved: true },
      { clientColumn: 'Mapa cuentas!mar-26:abr-27', standardField: 'date', confidence: 0.9, approved: true, notes: 'Formato ancho: cada mes debe convertirse en registros.' },
      { clientColumn: 'Valores positivos', standardField: 'income', confidence: 0.94, approved: true },
      { clientColumn: 'Valores negativos', standardField: 'expense', confidence: 0.94, approved: true, notes: 'Se guardan como egresos positivos para el modelo estandar.' },
      { clientColumn: 'Hoja1!SALDO ANTERIOR', standardField: 'openingBalance', confidence: 0.96, approved: true },
      { clientColumn: 'Hoja1!SALDO FINAL', standardField: 'closingBalance', confidence: 0.96, approved: true },
    ],
  },
  {
